...
public class FilterApples01 {
	...
	public static void main(String[] args) {

		{
			...
			System.out.println("Green Apples: " + filterApples(Inventory.APPLES, FilterApples01::isGreenApple));

			System.out.println("Heavy Apples: " + filterApples(Inventory.APPLES, FilterApples01::isHeavyApple));
